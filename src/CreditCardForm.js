...
function CreditCardForm() {
  ...
  return (
    <div className={styles.main_div}>
      <CreditCard data={userDetails} />
      <div className={styles.form_div}>
        <div style={{ marginTop: "3.2cm" }}>
          <form className={styles.form_data} onSubmit={onSubmitHandler}>
            <label className={styles.card_number_text}>Card Number</label>
            <br />
            <input
            ...
            <br />
            <br />
            <label className={styles.card_number_text}>Card Holders</label>
            <input
              className={styles.card_number_box}
            ...
            <label className={styles.card_number_text}>Expiration Date</label>
            <label
              className={styles.card_number_text}
              style={{ paddingLeft: "4.5cm" }}
            >
              cvv
            </label>
            <br />
